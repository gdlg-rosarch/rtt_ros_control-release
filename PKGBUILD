...
'ros-kinetic-rtt-trajectory-msgs'
)
...
_dir=rtt_control_msgs
source=()
md5sums=()

prepare() {
    cp -R $startdir/rtt_control_msgs $srcdir/rtt_control_msgs
}
